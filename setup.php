<?php
	...
	try 
	{
		...
		//create units table
		$fileDb->exec('CREATE TABLE IF NOT EXISTS tblUnits (unitId INTEGER PRIMARY KEY, unitName TEXT)');
		//create Ingredients table
		$fileDb->exec('CREATE TABLE IF NOT EXISTS tblIngredients (ingredientId INTEGER PRIMARY KEY, ingredientName TEXT)');
		//create workouts table
		$fileDb->exec('CREATE TABLE IF NOT EXISTS tblWorkOuts (workoutId INTEGER PRIMARY KEY, workoutName TEXT, workoutLocation TEXT, workoutReference TEXT)');
		//create recipes table
		$fileDb->exec('CREATE TABLE IF NOT EXISTS tblRecipes (recipeId INTEGER PRIMARY KEY, recipeName TEXT, recipeLocation TEXT, recipeReference TEXT)');
